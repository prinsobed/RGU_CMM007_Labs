...
<head>
    <meta charset="UTF-8">
    <title>ProdPredict | Uploaded Production Data</title>
...
<div class="container">
    <header>
        ...
        <div id="status">
            <p class="status"><a href="home.php">Home> Uploaded Production Data</a></p>
        </div>
    </header>
    ...
    <article>
        <div id="uploaded_prod_data">
            <form>
                <h3>Uploaded Production Data</h3>

                <input type='submit' value='Close' accesskey='2'>
                <input type='submit' value='Edit' accesskey='3'>
