...
<head>
    <meta charset="UTF-8">
    <title>ProdPredict | Upload Production Data</title>
...
<div class="container">
    <header>
        ...
        <div id="status">
            <p class="status"><a href="home.php">Home> Upload Production Data</a></p>
        </div>
    </header>
    ...
    <article>
        <div id="uploaded_prod_data">
            <form>
                <h3>Upload Production Data</h3><br>
                
                <input type='submit' value='Close' accesskey='2'>
                <input type='submit' value='Save Data' accesskey='3'>
